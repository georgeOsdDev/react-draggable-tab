...
var Tabs = (function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function doubleClickHandlerWithKey(key) {
      ...
      return function (e) {
        _this11.props.onTabDoubleClick(e, key);
      };
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      tabClassNames.tabActive = (0, _classnames2.default)('rdTabActive', this.props.tabsClassNames.tabActive);

      var content = [];
      var tabs = _lodash2.default.map(this.state.tabs, function (tab) {

        if (_this12.state.closedTabs.indexOf(tab.key) > -1) {
          return '';
        }
        ...
        if (_this12.state.selectedTab === tab.key) {
          ...
          tabClasses = (0, _classnames2.default)(tabClassNames.tab, 'rdTabActive', _this12.props.tabsClassNames.tabActive, tab.props.tabClassNames.tabActive);
        ...
        var closeButton = _this12.getCloseButton(tab, tabCloseIconStyle, tabCloseIconClasses, tabInlineStyles.tabCloseIconOnHover);
        ...
        return _react2.default.createElement(
          _reactDraggable2.default,
          {
            ...
            zIndex: 100,
            bounds: 'parent',
            onStart: _this12.handleDragStart.bind(_this12, tab.key),
            onDrag: _this12.handleDrag.bind(_this12, tab.key),
            onStop: _this12.handleDragStop.bind(_this12, tab.key) },
          _react2.default.createElement(
            'li',
            { style: tabStyle, className: tabClasses,
              onClick: _this12.handleTabClick.bind(_this12, tab.key),
              onMouseDown: _this12.handleMouseDown.bind(_this12, tab.key),
              ref: tab.key },
            _react2.default.createElement(
              'span',
            ...
            _react2.default.createElement(
              'p',
              { onDoubleClick: _this12.doubleClickHandlerWithKey(tab.key), style: tabTiteleStyle, className: tabTitleClasses },
              tabTitle
            ),
            _react2.default.createElement(
              'span',
